...
\begin{tabularx}{\linewidth}{c X c c c c X}
\toprule
...
\begin{enumerate}
    \item \textbf{Positive-Unlabeled (PU) Loss Formulations}: Use Positive-Unlabeled (PU) SPOCO + Multi-Planar Reconstruction (MPR) consistency loss to prevent instance suppression bias caused by the Training set's $\le 3$ instance annotation cap.
